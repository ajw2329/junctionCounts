...
export bam_dir=/public/groups/sanfordlab/people/anjowall/projects/rtpcr_validated/shen_2014/bam/
...
export fastq_dir=/public/groups/sanfordlab/people/anjowall/projects/rtpcr_validated/shen_2014//fastq/
export fastq_prefix_list=$(ls "$fastq_dir"/*fastq.gz | awk -F\/ '{ print $NF}' | awk -F"_[12].fastq" '{ print $1 }' | sort | uniq)
###

bam_dir_rmdup=/public/groups/sanfordlab/people/anjowall/projects/rtpcr_validated/shen_2014/bam_rmdup/
