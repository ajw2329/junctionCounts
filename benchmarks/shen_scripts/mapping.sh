...
export topdir=/public/groups/sanfordlab/people/anjowall/projects/rtpcr_validated/shen_2014/
export human_fastq_dir="$topdir"/fastq/
export human_genome_dir=/public/groups/sanfordlab/people/anjowall/genomes/hg19/STAR_genome_hg19/
export human_genome_fasta=/public/groups/sanfordlab/people/anjowall/genomes/hg19/STAR_genome_hg19/hg19.fa
